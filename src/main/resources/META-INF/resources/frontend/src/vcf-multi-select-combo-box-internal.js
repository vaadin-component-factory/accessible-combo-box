 ...
 */
import './vcf-multi-select-combo-box-item.js';
import './vcf-multi-select-combo-box-overlay.js';
import './vcf-multi-select-combo-box-scroller.js';
...
class MultiSelectComboBoxInternal extends ComboBoxDataProviderMixin(ComboBoxMixin(ThemableMixin(PolymerElement))) {
  static get is() {
    return 'vcf-multi-select-combo-box-internal';
  }
  ...
  static get template() {
    return html`
      ...
      <vcf-multi-select-combo-box-overlay
        id="overlay"
