 ...
 */
@Tag("vcf-combo-box")
@NpmPackage(value = "@vaadin/vaadin-overlay", version = "^3.2.14")
@NpmPackage(value = "@vaadin/input-container", version = "^23.3.11")
@NpmPackage(value = "@vaadin/field-base", version = "^23.3.11")
...
public abstract class ComboBoxBase<R extends ComboBoxBase<R, T>, T>
    ...
    public static class CustomValueSetEvent<R extends ComboBoxBase<R, ?>>
    ...
    public static class SelectedItemChangeEvent<R extends ComboBoxBase<R, ?>>
            extends ComponentEvent<R> {
    ...
    public static class OpenedChangeEvent<R extends ComboBoxBase<R, ?>>
            extends ComponentEvent<R> {
     ...
     *            the property type
     */
    public <P> ComboBoxBase(T initialValue, T defaultValue,
     ...
     */
    public ComboBoxBase(T initialValue, T defaultValue,
